...
const UpdateProfile = () => {
  ...
  const [aboutMe2, setAboutMe2] = useState(user && user.aboutMe);
  const [aboutMe3, setAboutMe3] = useState(user && user.aboutMe);
  ...
  const handleUpdateProfile = () => {
    ...
    formData.append("aboutMe2", aboutMe2);
    formData.append("aboutMe3", aboutMe3);
        ...
        <div>
          <div className="grid w-[100%] gap-6">
            ...
            <div className="grid gap-4">
              ...
              <div className="grid gap-2">
                <Label>About Me 2</Label>
                <Textarea
                  className="About Me"
                  value={aboutMe2}
                  onChange={(e) => setAboutMe2(e.target.value)}
                />
              </div>
              <div className="grid gap-2">
                <Label>About Me 3</Label>
                <Textarea
                  className="About Me"
                  value={aboutMe3}
                  onChange={(e) => setAboutMe3(e.target.value)}
                />
              </div>
              <div className="grid gap-2">
